...
const ClassListItem = (props) => {
    console.log(props)
    const { class_id, type_id, type_description, class_name, class_date, start_time, class_duration, intensity_id, class_location, max_class_size, class_instructor } = props.class;
